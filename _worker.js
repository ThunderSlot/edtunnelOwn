...
const พร็อกซีไอพีs = ['proxyip.fxxk.dedyn.io', 'cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org'];
...
<div style="display: flex; align-items: center;">
    <img src="https://i.ibb.co/XbZCnYL/Um1-Logo-1080p.png" alt="University of Medicine 1" style="max-width: 11%; max-height: 50%; margin-right: 20px;">
    <div style="font-size: 30px; font-weight: bold;">Dedicated Tunnel for UM1</div>
</div>
